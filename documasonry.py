...
class Documasonry:
  ...
  def add_templates_from_config(self):
    ...
    self.template_paths = [item['file'] for item in default_templates if item['selected']]
  ...
  def generate_required_fields_info_text(self, quick=False):
    ...
    if quick:
      text = '\n# required fields, generated by reading templates config.yaml file\n\n'
    else:
      text = '\n# required fields, generated by detecting template file content\n\n'
    for field in fields:
      text += '{}: \n'.format(field)
  ...
  def read_config(self):
    ...
    config = pylon.yaml_ordered_load(open(path, encoding='utf-8').read())
...
def test_load_config():
  ...
  masonry.read_config()
  masonry.add_templates_from_config()
