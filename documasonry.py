...
class Documasonry:
  ...
  def generate_required_fields_info_text(self, quick=False):
    ...
    if quick:
      ...
      text = '\n# required fields generated by reading templates\n\n'
    for field in fields:
      text += '{}: \n'.format(field)
  ...
  def combine_fields_info_text(self, info1_text, info2_text):
    # result = ''
    info1 = pylon.yaml_ordered_load(info1_text)
    if info1 is None:
      info1 = pylon.yaml_ordered_load('empty: ""')
    info2 = pylon.yaml_ordered_load(info2_text)
    if info2 is None:
      info2 = {}
    info1.update(info2)
